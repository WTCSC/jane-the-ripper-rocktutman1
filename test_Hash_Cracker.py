...
def test_md5_dehash():
    ...
    result = crack_passwords("test_files/test_wordlist.txt", "test_files/test_hashes.txt", "md5")
...
def test_sha1_dehash():
    ...
    result = crack_passwords("test_files/test_wordlist.txt", "test_files/test_hashes.txt", "sha1")
    assert result[0] == expected
def test_sha256_dehash():
    ...
    result = crack_passwords("test_files/test_wordlist.txt", "test_files/test_hashes.txt", "sha256")
    assert result[0] == expected
